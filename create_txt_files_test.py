...
experiment_name = "test_model_9_2_2_2_epoch_390" # NOTE change this for every new experiment

# NOTE! here you can choose what model's output you want to compute metrics for
with open("/home/fregu856/retinanet/training_logs/model_9_2_2_2/eval_dict_test.pkl", "rb") as file: # NOTE! you'll have to adapt this for your file structure
